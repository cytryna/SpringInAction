...
public class JdbcSpitterRepository implements SpitterRepository {
	...
	/**
	 * Zapisujemy użytkownika typu Spitter za pomocą klasy SimpleJdbcInsert. 
	 * Nie korzystamy bezpośrednio z języka SQL i mamy możliwość zwrócenia ID nowo utworzonego użytkownika.
	 * @param spitter użytkownik Spitter dodawany do bazy danych
	 * @return identyfikator nowo utworzonego użytkownika Spitter
	 */
	...
	/**
	 * Zapisujemy użytkownika typu Spitter za pomocą prostego wywołania metody update() klasy JdbcTemplate.
	 * Identyfikator nowo utworzonego użytkownika nie jest zwracany.
	 * @param spitter użytkownik Spitter dodawany do bazy danych
	 */
