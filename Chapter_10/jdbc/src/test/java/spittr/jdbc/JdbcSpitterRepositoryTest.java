...
public class JdbcSpitterRepositoryTest {
  ...
  public void save_newSpitter() {
    assertEquals(4, spitterRepository.count());
    Spitter spitter = new Spitter(null, "newbee", "chcewejsc", "New Bee",
  ...
  public void save_existingSpitter() {
    assertEquals(4, spitterRepository.count());
    Spitter spitter = new Spitter(4L, "arthur", "chcewejsc", "Arthur Names",
  ...
  public static void before() {
    SPITTERS[0] = new Spitter(1L, "habuma", "haslo", "Craig Walls",
        "craig@habuma.com", false);
    SPITTERS[1] = new Spitter(2L, "mwalls", "haslo", "Michael Walls",
        "mwalls@habuma.com", true);
    SPITTERS[2] = new Spitter(3L, "chuck", "haslo", "Chuck Wagon",
        "chuck@habuma.com", false);
    SPITTERS[3] = new Spitter(4L, "artnames", "haslo", "Art Names",
        "art@habuma.com", true);
    SPITTERS[4] = new Spitter(5L, "newbee", "chcewejsc", "New Bee",
        "newbee@habuma.com", true);
    SPITTERS[5] = new Spitter(4L, "arthur", "chcewejsc", "Arthur Names",
        "arthur@habuma.com", false);
  }
